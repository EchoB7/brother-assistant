    ...
    >
      ...
      {isDragOver && (
        <div className="mb-3 flex items-center justify-center rounded-xl border-2 border-dashed border-blue-400 bg-blue-50 p-4 dark:bg-blue-900/30">
          <p className="text-sm font-medium text-blue-600 dark:text-blue-300">Solte o arquivo aqui</p>
        </div>
      )}
        ...
        >
          ...
          <div className="flex flex-1 items-center">
            <input
              ...
              placeholder={attachments.length ? "Descreva o que quer fazer com o arquivo..." : "Pergunte qualquer coisa..."}
              disabled={disabled}
      ...
      <p className="mt-3 text-center text-[10px] font-medium text-slate-400">
        Brother usa IA. Verifique respostas importantes antes de agir.
      </p>
    </div>
  );
}
